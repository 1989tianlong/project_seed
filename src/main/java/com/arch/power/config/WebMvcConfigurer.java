...
import com.arch.power.core.ResultCode;
import com.arch.power.core.ServiceException;
...
public class WebMvcConfigurer extends WebMvcConfigurerAdapter {
	...
	@Override public void configureMessageConverters(List<HttpMessageConverter<?>> converters) {
		...
		config.setSerializerFeatures(SerializerFeature.WriteMapNullValue,//保留空字段
	...
	private boolean validateSign(HttpServletRequest request) {
		...
		String sign = DigestUtils.md5Hex(linkString + secret);//混合密钥
